...
export default async function OpsDashboard() {
  ...
  const topMetrics = [
    ...
    { label: "Pre-Qualified", value: prequalApprovedCount, icon: Shield, href: "/admin/buyers", color: "text-[#0B5FD1]" },
    { label: "Active Dealers", value: dealerCount, icon: Building2, href: "/admin/dealers", color: "text-[#0B5FD1]" },
    ...
    { label: "Active Threads", value: messageThreads, icon: MessageSquare, href: "/admin/messages", color: "text-[#0B5FD1]" },
  ];
    ...
    <div className="p-6 md:p-8 max-w-7xl" data-testid="ops-dashboard-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-white border border-slate-200 rounded-xl p-5" data-testid="ops-funnel-card">
          ...
          <Link href="/admin/reports/funnel" className="block mt-4 text-xs text-[#0B5FD1] hover:underline" data-testid="ops-full-funnel-link">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5" data-testid="ops-contract-card">
          ...
          <Link href="/admin/contract-shield" className="block mt-4 text-xs text-[#0B5FD1] hover:underline" data-testid="ops-contract-link">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5" data-testid="ops-messaging-card">
          <div className="flex items-center gap-2 mb-3">
            <MessageSquare size={15} className="text-[#0B5FD1]" />
          ...
          <Link href="/admin/messages" className="block mt-4 text-xs text-[#0B5FD1] hover:underline" data-testid="ops-messages-link">
            Manage messages →
          </Link>
        </div>
      </div>
      ...
      <div data-testid="ops-active-deals">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/admin/deals" className="text-xs text-[#0B5FD1] hover:underline" data-testid="ops-all-deals-link">
            View all
          </Link>
        </div>
          ...
          <div className="space-y-1.5">
            {recentDeals.map(deal => (
              <Link
                ...
                className="flex items-center justify-between bg-white border border-slate-100 rounded-lg px-4 py-2.5 hover:border-[#0B5FD1]/30 transition-colors"
              >
                <div>
                ...
                <div className="text-right">
                  <span className="text-xs font-semibold text-[#0B5FD1] bg-[#0B5FD1]/10 px-2 py-0.5 rounded-full">
