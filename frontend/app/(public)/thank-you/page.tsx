...
export const metadata: Metadata = {
  ...
  description:
    "Your vehicle request was received. Activate your private 48-hour dealer auction with a $99 deposit — refund on request. Verified dealers compete for your business.",
  robots: {
    index: false,
    follow: false,
    noarchive: true,
