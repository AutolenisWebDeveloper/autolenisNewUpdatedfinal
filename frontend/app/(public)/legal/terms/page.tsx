    ...
    <div data-testid="legal-terms-page">
      ...
      <div className="max-w-3xl mx-auto px-6 pb-20 space-y-4 mt-6">
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-2xl p-7 shadow-sm">
          ...
          <p className="text-sm text-[#4B5563] leading-relaxed">
            The $99 auction activation deposit is non-refundable except at
            AutoLenis&rsquo;s discretion: if no competitive offer is received, you
            may request a refund, which AutoLenis will review and, if approved,
            return to your original payment method. When you select a deal, the
            $99 deposit is credited toward the $499 concierge fee (charged only
            upon selection), resulting in a net charge of $400. All payments are
