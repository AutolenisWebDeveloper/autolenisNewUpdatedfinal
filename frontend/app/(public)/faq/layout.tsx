...
const FAQ_SCHEMA_ITEMS = [
  { question: "How does the $99 service fee work?", answer: "The $99 service fee (limited-time launch pricing) activates your private 48-hour reverse auction on the Standard tier. It is refundable only if no dealer offers are received within 72 hours; otherwise it is non-refundable." },
  ...
  { question: "What if no dealer submits an offer?", answer: "If no dealer offers are received within 72 hours, your $99 service fee is refunded in full within 3 business days. We may also re-run the auction at no additional cost." },
