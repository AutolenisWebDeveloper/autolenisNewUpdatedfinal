...
const DEPOSIT_STATS = [
  { label: "Refund on request", desc: "Refund available on request if no valuable offer is received" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Soft-pull only", "48-hour auction", "Refund on request", "Buyer-first"].map((badge) => (
                  <span
                    key={badge}
      ...
      <section className="py-20 md:py-28 bg-[#0A0F1A] relative overflow-hidden" data-testid="hiw-final-cta">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="text-xs text-white/50">
            Soft-pull only · Refund on request · 48-hour auction · No obligation
          </p>
        </div>
      </section>
