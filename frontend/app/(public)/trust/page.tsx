...
const TRUST_PILLARS = [
  { icon: CreditCard, title: "$99 Refund Guarantee", body: `${PRICING_COPY.refundLong} No fine print.`, accent: "text-[#059669]", bg: "bg-[#ECFDF5]", border: "border-[#A7F3D0]" },
      ...
      <section className="py-20 bg-[#F8F9FB]" data-testid="trust-guarantee-section">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <div className="bg-white border-2 border-[#DBEAFE] rounded-2xl p-12 shadow-sm shadow-[#0B5FD1]/5">
            ...
            <p className="text-[#4B5563] leading-relaxed mb-8 text-sm max-w-xl mx-auto">If AutoLenis does not surface at least one valuable offer at or below fair market value for your vehicle, your $99 Auction Access Fee is returned in full within 3 business days. No disputes.</p>
