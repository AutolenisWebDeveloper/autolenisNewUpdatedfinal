...
function PricingPageBody() {
  return (
    <div className="bg-white">
      ...
      {/* $99 Deposit Callout — Fix 1: replace non-brand green icon wrapper */}
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: "Yes. If no competitive offer is received within your auction window, the deposit is refundable based on platform policy.",
              },
              {
                q: "Are there any subscriptions?",
                a: "No. There are no monthly or recurring fees. The deposit is a one-time auction activation, and Premium is a one-time concierge fee.",
              },
              {
