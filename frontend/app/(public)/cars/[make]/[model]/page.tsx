...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    description: `Browse ${makeName} ${modelName} listings on AutoLenis. Let dealers compete for your business in a private 48-hour auction. Soft-pull prequalification. You can request a refund of your $99 if no competitive offer is received.`,
