...
const CATEGORIES: Record<string, CategoryDefinition> = {
  "suv": {
    ...
    description: "Browse SUV inventory and let dealers compete for your business. Soft-pull prequalification. Your $99 Auction Access Fee is refundable if no valuable offer is received.",
    filter: { bodyType: "SUV" },
    keywords: ["used SUVs", "SUVs for sale", "SUV best price", "buy SUV online"],
  },
  "trucks": {
    title: "Used Trucks for Sale",
    description: "Browse truck inventory and let dealers compete for your business. Soft-pull prequalification. Your $99 Auction Access Fee is refundable if no valuable offer is received.",
    filter: { bodyType: "Truck" },
    keywords: ["used trucks", "trucks for sale", "truck best price", "buy truck online"],
  },
  "sedans": {
    title: "Used Sedans for Sale",
    description: "Browse sedan inventory and let dealers compete for your business. Soft-pull prequalification. Your $99 Auction Access Fee is refundable if no valuable offer is received.",
    filter: { bodyType: "Sedan" },
    keywords: ["used sedans", "sedans for sale", "sedan best price", "buy sedan online"],
  },
  "under-25000": {
    title: "Used Cars Under $25,000",
    description: "Browse vehicles under $25,000 and let dealers compete for your business. No haggle. Soft-pull prequalification. Your $99 Auction Access Fee is refundable if no valuable offer is received.",
  ...
  "under-30000": {
    ...
    description: "Browse vehicles under $30,000 and let dealers compete for your business. No haggle. Soft-pull prequalification. Your $99 Auction Access Fee is refundable if no valuable offer is received.",
    filter: { maxPriceCents: 3000000 },
    keywords: ["used cars under 30000", "cars under $30k"],
  },
  "under-40000": {
    title: "Used Cars Under $40,000",
    description: "Browse vehicles under $40,000 and let dealers compete for your business. No haggle. Soft-pull prequalification. Your $99 Auction Access Fee is refundable if no valuable offer is received.",
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (resolved.kind === "city") {
    return buildPageMetadata({
      ...
      description: `Browse used vehicles in ${resolved.city}, ${resolved.stateAbbr}. Let dealers compete for your business. Soft-pull prequalification. Your $99 Auction Access Fee is refundable if no valuable offer is received.`,
      path: `/cars/${slug}`,
      keywords: [
  ...
  return buildPageMetadata({
    ...
    description: `Browse all ${resolved.name} models on AutoLenis. Let dealers compete for your business. Soft-pull prequalification. Your $99 Auction Access Fee is refundable if no valuable offer is received.`,
    path: `/cars/${slug}`,
