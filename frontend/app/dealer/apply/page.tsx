    ...
    return (
      ...
      >
        <div className="text-center max-w-xl w-full">
          <div className="w-16 h-16 rounded-full bg-[#0B5FD1]/10 flex items-center justify-center mx-auto mb-6">
            <CheckCircle2 size={32} className="text-[#0B5FD1]" />
          </div>
            ...
            {NEXT_STEPS.map((step, idx) => (
              <li key={step.label} className="bg-white border border-slate-200 rounded-xl p-5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <step.icon size={15} className="text-[#0B5FD1]" />
                </div>
    ...
    <div className="min-h-screen bg-white" data-testid="dealer-apply-page">
      <div className="mx-auto max-w-2xl px-6 py-16 md:py-24">
        <div className="text-center mb-10">
          ...
          <p className="text-xs tracking-widest uppercase font-semibold text-[#0B5FD1] mb-3">
            Dealer Application
          </p>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#F8F9FB] border border-[#E5E7EB] rounded-md text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-[#0B5FD1]/50 focus:ring-2 focus:ring-[#0B5FD1]/10 transition-colors"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-[#F8F9FB] border border-[#E5E7EB] rounded-md text-slate-900 text-sm focus:outline-none focus:border-[#0B5FD1]/50 focus:ring-2 focus:ring-[#0B5FD1]/10 transition-colors"
                >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-[#F8F9FB] border border-[#E5E7EB] rounded-md text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-[#0B5FD1]/50 focus:ring-2 focus:ring-[#0B5FD1]/10 transition-colors resize-none"
              />
            </div>
          </div>
          ...
          <p className="text-center text-xs text-slate-400">
            Already a dealer?{" "}
            <Link href="/dealer/sign-in" className="text-[#0B5FD1] hover:underline" data-testid="da-signin-link">
              Sign in
            </Link>
          </p>
        </form>
