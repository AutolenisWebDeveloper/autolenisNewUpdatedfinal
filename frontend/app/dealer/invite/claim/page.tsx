    ...
    <div className="min-h-screen bg-[#F8F9FB] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-2xl p-8 shadow-sm">
          {loading && <p className="text-al-primary text-sm text-center">Validating invitation...</p>}
          ...
          {!loading && invitation && !success && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button data-testid="invite-submit" type="submit" disabled={submitting} className="w-full bg-al-primary hover:bg-al-primary-hover disabled:opacity-50 text-white font-semibold py-3 rounded-xl transition-colors text-sm">{submitting ? "Creating Account..." : "Create Account & Join"}</button>
            </form>
          )}
