// lib/services/email/templates/dealer-new-buyer-opportunity.tsx
// Dealer New Buyer Opportunity — sent when a request-a-car case is routed to a dealer.
...
export const DEALER_NEW_BUYER_OPPORTUNITY_SUBJECT =
  "New Buyer Opportunity — AutoLenis";

export interface DealerNewBuyerOpportunityEmailProps {
  contactName: string;
...
export function renderDealerNewBuyerOpportunityEmail({
  contactName,
  vehicleInterest,
  buyerCity,
  buyerState,
  opportunityUrl,
}: DealerNewBuyerOpportunityEmailProps): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>New Buyer Opportunity — AutoLenis</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:#0B5FD1;padding:32px;text-align:center;">
              ...
              <p style="color:#DBEAFE;font-size:14px;margin:8px 0 0 0;">New Buyer Opportunity</p>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding:40px 40px 24px 40px;color:#333333;font-size:15px;line-height:1.6;">
              ...
              <p style="margin:0 0 24px 0;">A buyer in your area has submitted a vehicle request that has been matched to your dealership. Review the opportunity and respond to connect with this buyer.</p>
              <!-- Opportunity Details -->
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;border:1px solid #F0F9FF;border-radius:6px;overflow:hidden;">
                <tr>
                  <td style="padding:16px 20px;background:#F8F9FB;border-bottom:1px solid #F0F9FF;">
                    <p style="margin:0;font-size:13px;font-weight:bold;color:#0B5FD1;text-transform:uppercase;letter-spacing:0.5px;">Opportunity Details</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:16px 20px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:6px 0;font-size:14px;color:#888888;width:160px;">Vehicle Interest</td>
                        <td style="padding:6px 0;font-size:14px;color:#333333;font-weight:bold;">${vehicleInterest}</td>
                      </tr>
                      <tr>
              ...
              <p style="margin:0;font-size:13px;color:#888888;">Respond promptly to maximize your chances of winning this buyer.</p>
            </td>
          </tr>
          <!-- Footer -->
          <tr>
