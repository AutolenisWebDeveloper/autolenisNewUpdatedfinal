...
export const DEPOSIT_CONFIRMATION_SUBJECT = `Your ${DEPOSIT_AMOUNT_USD} AutoLenis Auction Access Deposit is confirmed`;
...
<head>
  ...
  <title>Auction Access Deposit Confirmed — AutoLenis</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:#0B5FD1;padding:32px;text-align:center;">
              ...
              <p style="color:#DBEAFE;font-size:14px;margin:8px 0 0 0;">Auction Access Deposit Confirmed ✓</p>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding:40px 40px 24px 40px;color:#333333;font-size:15px;line-height:1.6;">
              ...
              <p style="margin:0 0 16px 0;">Your ${DEPOSIT_AMOUNT_USD} Limited-Time Auction Access Deposit has been received. Your private auction is now active — dealers are being invited to compete for your business.</p>
              <!-- Receipt box -->
                ...
                <tr>
                  <td style="background:#F8F9FB;border-left:4px solid #0B5FD1;padding:14px 18px;border-radius:4px;">
                    <p style="margin:0;font-size:13px;color:#555555;line-height:1.6;">
                      If no valuable offer is received, <strong>you can request a refund of your ${DEPOSIT_AMOUNT_USD} Auction Access Deposit — our team reviews every request</strong>. Otherwise it is credited toward your AutoLenis concierge fee when your deal closes.
                    </p>
                  </td>
                </tr>
              </table>
