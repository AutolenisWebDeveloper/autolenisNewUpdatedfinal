// lib/services/email/templates/dealer-invitation.tsx
...
export interface DealerInvitationEmailProps {
  contactName: string;
...
export function renderDealerInvitationEmail({
  contactName,
  dealershipName,
  claimUrl,
  expiresAt,
}: DealerInvitationEmailProps): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>You've Been Invited to AutoLenis</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:#0B5FD1;padding:32px;text-align:center;">
              ...
              <p style="color:#DBEAFE;font-size:14px;margin:8px 0 0 0;">Private Dealer Auction Network</p>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding:40px 40px 24px 40px;color:#333333;font-size:15px;line-height:1.6;">
              ...
              <p style="margin:0 0 16px 0;">You have been invited to join <strong>AutoLenis</strong> — a private dealer auction network that connects pre-qualified buyers with trusted dealerships like <strong>${dealershipName}</strong>.</p>
              <p style="margin:0 0 24px 0;">Claim your dealer account now to start receiving buyer auction invitations and grow your sales pipeline.</p>
              <!-- CTA Button -->
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border-top:1px solid #eeeeee;padding-top:24px;margin-top:8px;">
                <tr>
                  <td>
                    <p style="margin:0 0 16px 0;font-weight:bold;color:#333333;font-size:14px;text-transform:uppercase;letter-spacing:0.5px;">Dealer Tier Benefits</p>
