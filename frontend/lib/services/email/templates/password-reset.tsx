// lib/services/email/templates/password-reset.tsx
...
export const PASSWORD_RESET_SUBJECT = "Reset your AutoLenis password";

export interface PasswordResetEmailProps {
  resetUrl: string;
}

export function renderPasswordResetEmail({ resetUrl }: PasswordResetEmailProps): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Reset Your AutoLenis Password</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 40px 24px 40px;color:#333333;font-size:15px;line-height:1.6;">
              <p style="margin:0 0 16px 0;">We received a request to reset the password for your AutoLenis account. Click the button below to set a new password.</p>
              <!-- CTA Button -->
              ...
              <p style="margin:0 0 16px 0;font-size:13px;color:#888888;">This link expires in 1 hour.</p>
              <p style="margin:0;font-size:13px;color:#888888;">If you did not request a password reset, you can safely ignore this email. Your password will not be changed.</p>
            </td>
          </tr>
          <!-- Footer -->
          <tr>
