...
export const CRON_STALENESS: Record<string, CronStalenessEntry> = {
  ...
  "esign-envelope-reconcile": { intervalMinutes: 15 }, // Program 4 durability: recover a dropped DocuSign completion/decline/void webhook (dormant without real DocuSign)
