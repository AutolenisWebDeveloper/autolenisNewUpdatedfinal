// AutoLenis Social Engine — Viral Hashtag Builder (Session C).
//
// Builds a per-platform hashtag set blending live trending hashtags, franchise
// tags, automotive niche tags, the brand tag, and optional make/geo tags. Each
// platform has its own cap and mix tuned to how that platform rewards hashtags.
...
export function buildViralHashtags(input: {
  ...
  switch (input.platform) {
    ...
    case "facebook":
      ...
      tags = [...trending.slice(0, 2), ...franchiseTags.slice(0, 2), brand];
      break;
