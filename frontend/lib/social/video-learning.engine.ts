// AutoLenis Social Engine — Video Learning Engine (Option B).
//
// Records per-(platform, franchise, hookType) completion + CTR performance into
// WinningPattern using a rolling average, then surfaces the best/worst hook types
// per platform so the Groq engine can bias future generations toward what works.
