// AutoLenis Social Engine — Viral Format Library (Session C, Option B).
//
// 13 proven viral post structures across 5 platforms. The Groq script engine
// uses these as generation templates so every post follows a structure that is
// engineered to stop the scroll, hold attention, and drive a save/share/comment.
