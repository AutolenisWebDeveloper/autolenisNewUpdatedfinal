// AutoLenis Social Engine — Content Recycling Engine (Gap 9).
//
// Resurfaces the best evergreen posts from 90-180 days ago, refreshes their
// hashtags with current trending data, and re-queues them as new posts so proven
// winners get a second life without re-generating from scratch.
...
export async function recyclePost(
  ...
  try {
    ...
    // Get the best posting slot — 2 days out.
    const now = new Date();
