// AutoLenis Social Engine — Synthetic Personalities (Session C).
//
// Four distinct content voices. The orchestrator selects one per franchise +
// platform and injects its voice, speaking style, and catchphrases into the
// Groq generation prompt so the brand speaks with a consistent, credible persona.
