...
export const PAGE_METADATA = {
  ...
  pricing: {
    ...
    description:
      "Start with a one-time $99 Auction Access Fee — refundable if no valuable offer is received — or go Premium for the full white-glove experience. No hidden fees.",
    path: "/pricing",
