  ...
  return (
    <section id="local" className="scroll-mt-20 bg-white py-16 md:py-20">
      <div className="mx-auto max-w-4xl px-6 md:px-12">
        ...
        {/* City testimonials are intentionally not rendered until real, documented,
            substantiated customer quotes exist. Placeholder testimonial slots must
            never be shown publicly (FTC + crawl-quality). When verified testimonials
            are wired to a data source, render them here. */}
      </div>
    </section>
  );
}
